          ...
          <div className="bg-white p-8 rounded-2xl border border-neutral-200">
            <form className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                <label className="flex items-center">
                  <input
                    type="checkbox"
                    className="w-4 h-4 text-[#8B7355] border-neutral-300 rounded focus:ring-[#8B7355]"
                  />
                ...
                <Link
                  ...
                  className="text-sm text-[#8B7355] hover:text-[#7A6548] transition-colors"
                >
                  Forgot Password?
                </Link>
              </div>
            ...
            <div className="mt-8">
              ...
              <div className="mt-6 grid grid-cols-2 gap-4">
                <button className="flex items-center justify-center px-4 py-3 border border-neutral-200 rounded-lg hover:bg-neutral-50 transition-colors">
